...
function abreFechaMenu(){
    ...
    let aberturaMenu = document.getElementById('cx_nav');
    ...
    if(window.matchMedia('(max-width: 720px').matches) {
        ...
        if(interacaoMenu == 0) {
            aberturaMenu.style.display = 'block';
            document.getElementById('iconResp').src = '../img/menu_resp_aberto_32x32.png';
            menuPrincipal.style.display = 'flex';
            headerNav.style.height = '500px';        
            interacaoMenu = 1
        } else {
            aberturaMenu.style.display = 'none';
            document.getElementById('iconResp').src = '../img/menu_resp_fechado_32x32.png';
